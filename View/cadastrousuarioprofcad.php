...
<head>
    ...
    <title>Usuários | Professores</title>
        ...
        <nav id="sidebar">
            ...
            <div class="p-3">
                ...
                <ul class="list-unstyled components mb-3" style="padding-left: 20px">
                    ...
                    <li>
                        <a href="agendamento.php"><span class="fa fa-sticky-note mr-3"></span> Agendamentos</a>
                    </li>
                    <li>
                        <a href="cadastroequipamento.php"><span class="fa fa-wrench mr-3"></span> Equipamentos</a>
                    </li>
                    <li class="active">
                        <a href="cadastrousuario.php"><span class="fa fa-users mr-3"></span> Usuários</a>
                    </li>
                    <li>
            ...
            <div class="container p-30">
                        ...
                        <div class="card_body">
                            <div class="row d-flex">
                                <div class="col-sm-6 createSegment">
                                    <button class="botao-registro" style="border: none; background: none;"> <a class="btn dim_button create_new" href="#"> <span class="glyphicon glyphicon-plus"></span> Novo Registro </a> </button>
                                    <button  style="border: none; background: none;"><a class="btn dim_button create_new" href="cadastrousuario.php"> <span class="glyphicon glyphicon-user" style="padding-right:0.5px"></span> Administradores</a></button>
                                </div>
                ...
                <div class='btn-group'>
                    ...
                    <ul class='dropdown-menu dropdown_more'>
                        ...
                        <li>
                            <a href='cadastrousuario.php?codigo=" . $usuario['usu_id'] . "&nome=" . $usuario['usu_nome'] . "&email=" . $usuario['usu_email'] . "&login=" . $usuario['usu_login'] . "&senha=" . $usuario['usu_senha'] . "'>
            ...
            <div class="grupo-modal">
                <div class="estrutura">
                    ...
                    <div class="corpo-modal">
                        <div class="form-usu">
                            <div class="titulo">Cadastrar Professor</div>
