                        ...
                        <div class="card_body">
                            ...
                            <div class="row d-flex">
                                <div class="col-sm-6 createSegment">
                                    ...
                                    <button style="border: none; background: none;"><a class="btn dim_button create_new" href="agendamentoprof.php"> <span class="glyphicon glyphicon-list-alt"></span> Agendamentos Totais</a></button>
                                </div>
                            ...
                            <form method="POST" action="../Controller/rotas.php?acao=cadastrar&tipo=agendamentoprof">
                                <div class="form-corpo">
                                    ...
                                    <div class="campo">
                                        ...
                                        <input name="professor" type="text" value="<?php foreach ($listaProfessor as $usuario) {
                                                                                        if ($usuario['usu_login'] == $_SESSION['loginprof']) {
                                                                                            echo $usuario['usu_nome'];
                                                                                        }
                                                                                    } ?>" readonly>
