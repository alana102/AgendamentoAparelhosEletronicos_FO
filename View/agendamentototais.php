...
<head>
    ...
    <title>Agendamentos | Total</title>
...
<body>
                        ...
                        <div class="card_body">
                            <div class="row d-flex">
                                <div class="col-sm-8 createSegment">
                                    ...
                                    <button style="border: none; background: none;"><a class="btn dim_button create_new" href="agendamento.php"> <span class="glyphicon glyphicon-list-alt"></span> Agendamentos de hoje </a></button>
                                </div>
                            ...
                            <div class="overflow-x">
                                <table style="width: 100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                                    ...
                                    <tbody>
                                        ...
                                        function getProfessorEmail($listaProfessor, $professorNome)
                                        {
                                            foreach ($listaProfessor as $professorEmail) {
                                                if ($professorEmail['usu_nome'] == $professorNome) {
                                                    return $professorEmail['usu_email'];
                                                }
                                            }
                                            return null;
                                        }
                                        ...
                                        foreach ($listaAgendamento as $agendamento) {
                                            ...
                                            $emailprof = getProfessorEmail($listaProfessor, $agendamento['agen_prof']);
                                            $remetente = "os143170@gmail.com";
                                            $assunto = "Devolução de equipamento";
                                            $mensagem = "Olá, " . $agendamento['agen_prof'] . ", você tem o agendamento do
                                            " . $agendamento['tipo_nome'] . ": " . $agendamento['equ_nome'] . " pendente. Resolva
                                            sua pendência assim que possível!";
                                            ...
                                            if ($valor != "Concluído" && $dataagendada <= $data) {
                                                $concluir = "<li>
                                    ...
                                    <td>
                                        ...
                                        <div class='btn-group'>
                                            ...
                                            <ul class='dropdown-menu dropdown_more'>" . $concluir . "
                                                ...
                                                <li>
                                                    <a href='agendamento.php?codigo=" . $agendamento['agen_id'] .
    ...
    <script src="js/datatable_total.js"></script>
