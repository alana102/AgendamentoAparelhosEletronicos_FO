	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			<div class="cardBox">
				...
				<a href="cadastrousuarioprofcad.php">
			...
			<div class="card-avisos" style="background-color: #F3C193; width: 100%; height: auto; border-radius: 20px; margin-top: 50px;box-shadow: 0 2px 10px #737e7f;">
				...
				<div class="elementos">
					...
					foreach ($listaAgendamento as $agendamento) {
						...
						if ($valor == "Pendente") {
							echo "<h6 class='h6 mb-3' style='font-size: 18px; margin: 30px; padding-top: ; font-weight:600'><a href='agendamentototais.php'><button
					...
					border-radius:50%; cursor:pointer'></button></a>
					 " . implode(" ", $doisPrimeirosNomes) . " tem o agendamento do(a) " . $agendamento['tipo_nome'] . ": " . $agendamento['equ_nome'] . " pendente do dia " . $agendamento['agen_data'] . "!
				</h6>";
						} else if ($valor == "Agendado" && $dataagendada==$data) {
							echo "<h6 class='h6 mb-3' style='font-size: 18px; margin: 30px; padding-top: ; font-weight:600'><a href='agendamentototais.php'><button
					style='background-color: #3B5E7E; border-radius:40px; border: 1px solid black; height:15px; width:15px;  
					border-radius:50%; cursor:pointer'></button></a>
					 " . implode(" ", $doisPrimeirosNomes) . " está com o(a) " . $agendamento['tipo_nome'] . ": " . $agendamento['equ_nome'] . " agendado(a) da " . $agendamento['aula_inicio'] . " até a " . $agendamento['aula_fim'] . "!
				</h6>";
						}
					}
					?>
